          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            >
              <AppLogo 
                src={appLogo} 
                alt={appName} 
                className="w-8 h-8 sm:w-10 sm:h-10 md:w-11 md:h-11 rounded-xl" 
                containerClassName="shrink-0 group-hover:scale-105 transition-transform duration-200"
              />
              <span className="font-black text-lg sm:text-xl tracking-tight bg-gradient-to-r from-amber-500 via-amber-400 to-yellow-500 bg-clip-text text-transparent font-sans hidden lg:inline-block">
                SomLuul
              </span>
            </div>
