...
import {
  ...
  ChevronDown, Check, CheckCheck, Loader2, ArrowLeft
} from 'lucide-react';
...
export const FloatingChat: React.FC<FloatingChatProps> = ({
  ...
  useEffect(() => {
    ...
    // Poll chat messages every 4 seconds for real-time responsiveness
  ...
  const toggleRecording = (chatId: string) => {
                    ...
                    roomMsgs.map((m, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-[9px] text-gray-400 px-1">{m.created_at || 'Just now'}</span>
                        </div>
                      );
                    })
                  )}
                ...
                <div className="p-2.5 bg-white dark:bg-[#182232] border-t border-gray-200 dark:border-gray-800 shrink-0 space-y-1.5">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <button
                      ...
                      title={isRec ? 'Stop & Send Voice Note' : 'Record Voice Note'}
                    >
                      <Mic size={18} />
                    </button>
