      ...
      {isAuthModalOpen && (
        ...
        <div className="flex flex-col items-center mb-6 text-center">
          <AppLogo 
            ...
            containerClassName="mb-3 p-1.5 bg-white dark:bg-gray-800 border-2 border-blue-500/30 shadow-xl hover:scale-105 transition-transform duration-300"
          />
          <h2 className="text-2xl font-black font-sans tracking-tight text-gray-900 dark:text-white flex items-center gap-1.5">
            {appName}
          </h2>
